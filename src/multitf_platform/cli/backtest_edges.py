...
def backtest_stat_arb(pair: tuple, h1_data: dict, equity: float = 10300.0):
...
def backtest_session_momentum(symbol: str, h1_data: pd.DataFrame, equity: float = 10300.0):
...
def backtest_gap_fade(symbol: str, h1_data: pd.DataFrame, equity: float = 10300.0):
